...
bool                compareMaya(vector<string> const &maya,
                                vector<string> const& tmpMaya,
...
void                            splitBase(unsigned long long int resultInt,
                                        vector<unsigned long long int> &resultsInt,
                                        int power, bool begin)
{
...
vector<string>      intToMaya(unsigned long long int number,
                        vector<string> const& motif, int L, int H)
{
    vector<string>  maya;
...
unsigned long long int      mayaToInt(vector<string> const& maya,
                                    vector<string>const& motif, int L, int H)
{
    string                  tmp;
